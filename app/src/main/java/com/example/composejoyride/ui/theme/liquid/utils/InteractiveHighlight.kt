package com.example.composejoyride.ui.theme.liquid.utils
...
class InteractiveHighlight(
    ...
    private val positionAnimationSpec =
        spring(0.5f, 300f, Offset.Companion.VisibilityThreshold)
        ...
        Modifier.Companion.drawWithContent {
            ...
            if (progress > 0f) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU && shader != null) {
                    drawRect(
                        Color.Companion.White.copy(0.08f * progress),
                        blendMode = BlendMode.Companion.Plus
                    )
                    shader.apply {
                    ...
                    drawRect(
                        Color.Companion.White.copy(0.25f * progress),
                        blendMode = BlendMode.Companion.Plus
                    )
                }
            }
